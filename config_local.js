...
config.MONGO_URI = "mongodb://localhost:27017/EOS";
...
config.CRON = true;
config.CRON_API = "https://api.daobet.org";
...
config.customChain = "https://api.daobet.org";

// api url for history
config.historyChain = "http://localhost:3333";
